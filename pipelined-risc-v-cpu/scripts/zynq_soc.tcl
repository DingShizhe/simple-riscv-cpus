...
#==============================================
  ...
  create_bd_port -dir I -type rst riscv_cpu_reset_n
  set_property CONFIG.ASSOCIATED_RESET {riscv_cpu_reset_n} [get_bd_ports ps_fclk_clk0]

#==============================================
# Export AXI Interface
#==============================================
  # Connect to DoCE AXI-Lite slave
  set riscv_cpu_axi_if [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 riscv_cpu_axi_if]
  set_property -dict [ list CONFIG.PROTOCOL {AXI4Lite} ] $riscv_cpu_axi_if

  set_property CONFIG.ASSOCIATED_BUSIF {riscv_cpu_axi_if} [get_bd_ports ps_fclk_clk0]
...
#=============================================
  ...
  connect_bd_net -net riscv_cpu_reset_n [get_bd_pins riscv_cpu_reset_n] \
...
#==============================================
  ...
  connect_bd_intf_net -intf_net riscv_cpu_axi_if [get_bd_intf_pins axi3_to_lite_pc/M_AXI] \
			[get_bd_intf_pins riscv_cpu_axi_if] 
...
#=============================================
  ...
  # MMIO registers
  create_bd_addr_seg -range 0x400000 -offset 0x40000000 [get_bd_addr_spaces armv7_processing_system/Data] [get_bd_addr_segs riscv_cpu_axi_if/Reg] PS_VIEW_RISCV_MEM
